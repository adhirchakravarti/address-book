...
class Contact extends Component {
    ...
    displayModalHandler = () => {
        ...
        console.log(document.querySelectorAll('.outer')[0]);
        console.log(document.getElementsByClassName('outer')[0].clientHeight);
    ...
    render() {
        ...
        return (
            <Aux>
                ...
                {/* {editForm} */}
                <Modal show={this.state.showModal} modalClosed={this.hideModalHandler} height={this.state.modalHeight} width={this.state.modalWidth} top={this.state.modalTop} left={this.state.modalLeft}>
